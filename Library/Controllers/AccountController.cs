...
using Itera.Fagdag.November.Identity;
...
{
    [Authorize]
    public class AccountController : Common
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError(String.Empty, "Таны оруулсан хэрэглэгчийн нэр нууц үг буруу байна");
            return View(model);
        }
        ...
        public async Task<ActionResult> Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Таны нууц үг өөрчлөгдсөн байна."
        ...
        public async Task<ActionResult> Manage(ManageUserViewModel model)
        {
            ...
            {               
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError(String.Empty, "Нууц үг буруу байна");
                    }
                }
            }
            else
